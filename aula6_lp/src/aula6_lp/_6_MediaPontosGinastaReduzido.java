...
public class _6_MediaPontosGinastaReduzido {
	public static void main(String[] args) {
		...
		if (nota1 > nota2 && nota1 > nota3 && nota1 > nota4 && nota1 > nota5 && nota1 > nota6) {
			notaMaior = nota1;
		} else if (nota2 > nota3 && nota2 > nota4 && nota2 > nota5 && nota2 > nota6) {
			notaMaior = nota2;
		} else if (nota3 > nota4 && nota3 > nota5 && nota3 > nota6) {
			notaMaior = nota3;
		} else if (nota4 > nota5 && nota3 > nota6) {
			notaMaior = nota4;
		} else if (nota5 > nota6) {
			notaMaior = nota5;
		} else {
